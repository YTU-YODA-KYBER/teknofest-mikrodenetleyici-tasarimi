...
(
    ...
    //  AR PORTLARI
    assign axi_instr_arid    = instr_axi_istegi.ar.id;
    assign axi_instr_araddr  = instr_axi_istegi.ar.addr;
    assign axi_instr_arlen   = instr_axi_istegi.ar.len;
    assign axi_instr_arsize  = instr_axi_istegi.ar.size;
    assign axi_instr_arburst = instr_axi_istegi.ar.burst;
    assign axi_instr_arprot  = instr_axi_istegi.ar.prot;
